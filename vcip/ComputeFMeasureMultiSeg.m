...
load(strcat(DBpath, '\', 'img_list.mat'));
for i = 1:100
   Lpath{i,1} = fls(i).name; 
end
...
for i=1:length(Lpath)
    ...
    [Pmax Rmax Fmax Frag]=CalcCandScore(cell2mat(strcat(DBpath,Sep,lower(Lpath(i)),Sep,SegResultsSubPath,Sep)),Hmask);
    Results(i,1)=Fmax;
    Results(i,2)=Rmax;
    Results(i,3)=Pmax;
    Results(i,4)=Frag;
end;
dlmwrite('2objdataset_minF_fragment.txt', Results);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
