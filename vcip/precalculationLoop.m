...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [V, E] = precalculationLoop(Iin, connectivity, row, col, dim, colourspace, distF)
numofedge = 1;
...
if strcmp(distF, 'brayCurtis')
   Diff = brayCurtisDistance(X, Y);
elseif strcmp(distF, 'euclidien')
    Diff = EuclidientD(X, Y);
elseif strcmp(distF, 'mahal')
    Diff = mahaldistanceglobal(X,Y);
elseif strcmp(distF, 'deltaE2000')
    Diff = deltaE2000(X, Y);
end
