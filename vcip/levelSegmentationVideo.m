function levelSegmentationVideo(pathname, filename, subfolder, framenumber)
...
segmentmapAll = segmentMapGenerator02Video(row,col,dim,V,E,showfigure,showrandom,postprocess,J,pixelLevel,framenumber);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
